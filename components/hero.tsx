    ...
    return (
        <div className='max-w-8xl h-[700px] flex items-center justify-center gap-2 rounded-3xl bg-blue-100 p-10 shadow-2xl bg-[url("/images/hero-bg.jpg")] bg-cover bg-center bg-no-repeat '>
            ...
            <div className='w-1/2 h-full flex items-end justify-center rounded-3xl overflow-hidden relative'>
                ...
                <Floaters image={Python} className='w-20 bottom-52 left-10' />
                <Floaters image={ReactJS} className='w-20 bottom-52 right-10' />
                <Floaters image={Fastapi} className='w-20 bottom-80 right-44' />
                <Floaters image={Nextjs} className='w-20 top-40 left-72' />
                <Floaters image={AWS} className='w-20 bottom-80 left-36' />
            </div>
